# Generated by Powerlevel10k configuration wizard on 2026-08-09 at 00:24 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # --- DevSecOps: Cloud & IaC context ---
    kubecontext             # current kubernetes context
    terraform               # terraform workspace
    aws                     # aws profile
    azure                   # azure account name
    gcloud                  # google cloud cli account and project
    # --- Runtime envs (shown only when active) ---
    virtualenv              # python virtual environment
    pyenv                   # python environment
    nvm                     # node.js version from nvm
    direnv                  # direnv status
    # --- System resources ---
    load                    # CPU load (1m avg, color-coded)
    ram                     # free RAM
    disk_usage              # disk usage (/ partition)
    swap                    # used swap
    # --- Identity & time ---
    context                 # user@hostname (shown when SSH/root)
    time                    # current time
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  # Show disk usage only when it reaches warning level (keeps prompt clean)
  ...
  # Show 1-minute load average (most responsive for devsecops monitoring)
  ...
  # Show context always when root or SSH; hide for normal local sessions
  ...
  # Uncomment below to always show context (user@host) even in local sessions:
  ...
  # Always show terraform workspace (including 'default') in devsecops workflow
  ...
  # Show kubecontext always in devsecops workflow (not just on k8s commands)
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND=''  # always show
  ...
  # Always show AWS profile — critical for devsecops to avoid wrong-account actions
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND=''  # always show
